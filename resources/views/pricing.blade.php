...
<head>
  ...
  <title>Employee Management | Pricing </title>
          ...
          <nav class="navbar navbar-expand-lg">
            ...
            <div class="navbar-collapse">
              <ul id="nav" class="navbar-nav mx-auto">
                ...
                <li class="nav-item">
                  <a class="ud-menu-scroll active" href="pricing.html">Pricing</a>
                </li>
                <li class="nav-item">
          ...
          <div class="ud-single-faq wow fadeInUp" data-wow-delay=".1s">
            <div class="accordion">
              <button class="ud-faq-btn collapsed" data-bs-toggle="collapse" data-bs-target="#collapseOne">
                ...
                <span>How does the multi-tenant system ensure data security between companies?</span>
              </button>
          ...
          <div class="ud-single-faq wow fadeInUp" data-wow-delay=".15s">
            <div class="accordion">
              <button class="ud-faq-btn collapsed" data-bs-toggle="collapse" data-bs-target="#collapseTwo">
                ...
                <span>Can I manage multiple companies with one account?</span>
              </button>
          ...
          <div class="ud-single-faq wow fadeInUp" data-wow-delay=".2s">
            <div class="accordion">
              <button class="ud-faq-btn collapsed" data-bs-toggle="collapse" data-bs-target="#collapseThree">
                ...
                <span>What features are included in the payroll management system?</span>
              </button>
          ...
          <div class="ud-single-faq wow fadeInUp" data-wow-delay=".1s">
            <div class="accordion">
              <button class="ud-faq-btn collapsed" data-bs-toggle="collapse" data-bs-target="#collapseFour">
                ...
                <span>Is the platform customizable for different industries?</span>
              </button>
          ...
          <div class="ud-single-faq wow fadeInUp" data-wow-delay=".15s">
            <div class="accordion">
              <button class="ud-faq-btn collapsed" data-bs-toggle="collapse" data-bs-target="#collapseFive">
                ...
                <span>How do employees log their attendance or request PTO?</span>
              </button>
          ...
          <div class="ud-single-faq wow fadeInUp" data-wow-delay=".2s">
            <div class="accordion">
              <button class="ud-faq-btn collapsed" data-bs-toggle="collapse" data-bs-target="#collapseSix">
                ...
                <span>What is the pricing structure, and are there free trial options?</span>
              </button>
