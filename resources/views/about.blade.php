<x-layout>
  <x-slot name="title">Employee Management | About</x-slot>
</head>
...
<body>
          ...
          <nav class="navbar navbar-expand-lg">
            ...
            <div class="navbar-collapse">
              <ul id="nav" class="navbar-nav mx-auto">
                ...
                <li class="nav-item">
                  <a class="ud-menu-scroll active" href="about.html">About</a>
                </li>
                <li class="nav-item">
      ...
      <div class="ud-about-wrapper wow fadeInUp" data-wow-delay=".2s">
        <div class="ud-about-content-wrapper">
          <div class="ud-about-content">
            ...
            <h2>Effortlessly Manage Employees Across Companies</h2>
            <p>
  ...
  <section id="team" class="ud-team">
    <div class="container">
      ...
      <div class="row">
        <div class="col-xl-3 col-lg-3 col-sm-6" id="team-single">
          <div class="ud-single-team wow fadeInUp" data-wow-delay=".1s"
          onclick="window.location.href='cv-ag.html'"
        ...
        <div class="col-xl-3 col-lg-3 col-sm-6">
          ...
          onclick="window.location.href='cv-ca.html'"
          style="cursor: pointer;"
          >
            <div class="ud-team-image-wrapper">
              <div class="ud-team-image">
        ...
        <div class="col-xl-3 col-lg-3 col-sm-6">
          ...
          onclick="window.location.href='cv-esh.html'"
          style="cursor: pointer;"
          >
            <div class="ud-team-image-wrapper">
              <div class="ud-team-image">
