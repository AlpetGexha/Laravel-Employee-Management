<x-layout>
        ...
        <div class="col-lg-12">
          <div class="ud-hero-content wow fadeInUp" data-wow-delay=".2s">
            ...
            <p class="ud-hero-desc">
              Play Solutions provides state-of-the-art SaaS tools for managing employees across multiple
              companies. From onboarding to payroll, streamline every process with confidence.
            </p>
            <ul class="ud-hero-buttons">
              <li>
                <a href="http://127.0.0.1:8000" rel="nofollow noopener" target="_blank"
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="ud-section-title">
            <span>Features</span>
            <h2>Effortlessly Manage Employees Across Companies
            </h2>
            <p>
              Our SaaS platform includes all the essential tools to manage employees across different departments and
              projects while maintaining robust security and efficiency
            </p>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-xl-3 col-lg-3 col-sm-6">
          <div class="ud-single-feature wow fadeInUp" data-wow-delay=".1s">
            <div class="ud-feature-icon">
              <svg width="40" height="40" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
            ...
            <div class="ud-feature-content">
              <h3 class="ud-feature-title">Employee Life Cycle</h3>
              <p class="ud-feature-desc">
                Tools for onboarding, role assignments, PTO management, and more, tailored for your business needs. </p>
        ...
        <div class="col-xl-3 col-lg-3 col-sm-6">
          <div class="ud-single-feature wow fadeInUp" data-wow-delay=".15s">
            <div class="ud-feature-icon">
              <svg class="text-white" width="50" height="50" fill="none" viewBox="0 0 25 24"
            ...
            <div class="ud-feature-content">
              <h3 class="ud-feature-title">Payroll Automation</h3>
              <p class="ud-feature-desc">
                Track salaries, bonuses, and deductions, and generate precise payroll reports in no time.
              </p>
              <a href="javascript:void(0)" class="ud-feature-link">
                Learn More
              </a>
        ...
        <div class="col-xl-3 col-lg-3 col-sm-6">
          <div class="ud-single-feature wow fadeInUp" data-wow-delay=".2s">
            ...
            <div class="ud-feature-content">
              <h3 class="ud-feature-title">Secure Access Control</h3>
              <p class="ud-feature-desc">
                Advanced security with 2FA, password recovery, and role-based access control.
              </p>
              <a href="javascript:void(0)" class="ud-feature-link">
                Learn More
              </a>
        ...
        <div class="col-xl-3 col-lg-3 col-sm-6">
          <div class="ud-single-feature wow fadeInUp" data-wow-delay=".25s">
            ...
            <div class="ud-feature-content">
              <h3 class="ud-feature-title">Multi-Tenant Architecture</h3>
              <p class="ud-feature-desc">
                Centralized database ensuring data segregation and security for managing multiple companies
                effortlessly.
              </p>
              <a href="javascript:void(0)" class="ud-feature-link">
                Learn More
      ...
      <div class="ud-about-wrapper wow fadeInUp" data-wow-delay=".2s">
        <div class="ud-about-content-wrapper">
          <div class="ud-about-content">
            ...
            <h2>
              Effortlessly Manage Employees Across Companies
            </h2>
            <p>
              Our SaaS platform includes all the essential tools to manage employees across different departments and
              projects while maintaining robust security and efficiency
        ...
        <div class="col-lg-4 col-md-6 col-sm-10">
          <div class="ud-single-pricing first-item wow fadeInUp" data-wow-delay=".15s">
            ...
            <div class="ud-pricing-body">
              <ul>
                <li>Single Company Access</li>
                <li>Basic Employee Management Features</li>
                <li>Basic Employee Management Features</li>
                <li>Basic Employee Management Features</li>
                <li>Limited to 20 Employees</li>
              </ul>
            </div>
  ...
  <!-- ====== FAQ Start ====== -->
  <section id="video" class="ud-faq">
    <div class="shape">
      <img src="assets/images/faq/shape.svg" alt="shape" />
    </div>
    <!--====== VIDEO ONE PART START ======-->
    <div class="video-area video-one">
      <div class="container">
        ...
        <div class="row justify-content-center">
          <div class="col-lg-10">
            <div class="video-content text-center">
              <img src="assets/images/video-image.png" width="900px" alt="Video" />
              <a class="video-popup glightbox" href="https://www.youtube.com/watch?v=aircAruvnKk">
  ...
  <section id="testimonials" class="ud-testimonials">
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="ud-brands wow fadeInUp" data-wow-delay=".2s" id="brands">
            <div class="ud-title">
              <h6>Trusted and Used by</h6>
            </div>
            <div class="ud-brands-logo">
              <div class="ud-single-logo">
                <img src="assets/images/brands/laravel-svgrepo-com.svg" alt="ayroui" />
              </div>
              <div class="ud-single-logo">
                <img src="assets/images/brands/filament.svg" alt="ecommerce-html" />
              </div>
              <div class="ud-single-logo">
  ...
  <!-- ====== Footer Start ====== -->
  <footer id="footer" class="ud-footer wow fadeInUp" data-wow-delay=".15s">
          ...
          <div class="col-xl-3 col-lg-6 col-md-8 col-sm-10">
            <div class="ud-widget">
              ...
              <ul class="ud-widget-brands">
                ...
                <li>
                  <a href="https://sentry.io/welcome/" rel="nofollow noopner" target="_blank">
                    <img src="assets/images/footer/brands/sentry.svg" alt="sentry" />
                  </a>
                </li>
                </li>
              </ul>
