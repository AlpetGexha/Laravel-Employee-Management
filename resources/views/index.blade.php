                ...
                <div class="col-lg-12">
                    <div class="ud-hero-content wow fadeInUp" data-wow-delay=".2s">
                        ...
                        <p class="ud-hero-desc">
                            Play Solutions provides state-of-the-art SaaS tools for managing employees across
                            multiple
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ud-section-title">
                        ...
                        <p>
                            Our SaaS platform includes all the essential tools to manage employees across
                    ...
                    <div class="ud-single-feature wow fadeInUp" data-wow-delay=".1s">
                        ...
                        <div class="ud-feature-content">
                            ...
                            <p class="ud-feature-desc">
                                Tools for onboarding, role assignments, PTO management, and more, tailored for
                ...
                <div class="col-xl-3 col-lg-3 col-sm-6">
                    <div class="ud-single-feature wow fadeInUp" data-wow-delay=".15s">
                        ...
                        <div class="ud-feature-content">
                            ...
                            <p class="ud-feature-desc">
                                Track salaries, bonuses, and deductions, and generate precise payroll reports in
                                no time.
                            </p>
                            <a href="javascript:void(0)" class="ud-feature-link">
                                Learn More
                ...
                <div class="col-xl-3 col-lg-3 col-sm-6">
                    <div class="ud-single-feature wow fadeInUp" data-wow-delay=".25s">
                        ...
                        <div class="ud-feature-content">
                            ...
                            <p class="ud-feature-desc">
                                Centralized database ensuring data segregation and security for managing
                                multiple companies
                                effortlessly.
                            </p>
                            <a href="javascript:void(0)" class="ud-feature-link">
